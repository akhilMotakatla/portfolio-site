...
function AboutMe() {
  return (
    <section className="about-me">
      <h2>About Me</h2>
      <p>
        Hey! I’m a versatile Software Engineer with 5+ years rocking .NET, C#, ASP.NET Core, and Azure 🌐. 
        Just finished my Master’s in Computer Science at the University of North Texas (yep, I was also a Graduate Teaching Fellow — teaching is my jam! 🎓👨‍🏫).
      </p>
      <p>
